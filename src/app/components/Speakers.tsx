...
const speakers: Speaker[] = [
  ...
  {
    name: 'Майлз',
    role: 'Хип-хоп артист из Бишкека. Его музыка многогранна, как его видение. Он не боится смешивать звучания и пробовать себя в направлениях рэпа — от старой до новой. Хип-хоп для него не просто жанр, а целая культура. Философия в строках раскрывает его как человека, рифмовка и флоу усиливают образ',
    accent: null,
