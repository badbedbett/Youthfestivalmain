...
const speakers: Speaker[] = [
  ...
  {
    name: 'Майлз',
    role: 'Хип-хоп артист из Бишкека. Его музыка многогранна. Он не боится смешивать звучания и пробовать себя в направлениях рэпа — от старой до новой школы. Хип-хоп для него — это целая культура. Философия в строках раскрывает его как человека, рифмовка и флоу усиливают образ',
    accent: null,
  ...
  {
    name: 'Пару ночей',
    role: 'ПАРУ НОЧЕЙ — российская альтернативная рок-группа из Казани. Они начали свой путь с уличных выступлений и перешли к крупным сценам по всей России. Это доказывает, что необходимо создавать искреннюю музыку, ведь музыка — это о настоящих эмоциях и пережитом опыте',
    accent: null,
    img: '/images/speakers/paru-nochey.jpg',
    imgPosition: 'center 20%',
    time: '14:00–22:00',
    location: 'Главная сцена',
    lecture: 'Артист',
