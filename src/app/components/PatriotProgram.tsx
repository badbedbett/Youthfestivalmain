...
const patriotActivities = [
  {
    ...
    desc: (
      <>
        Полоса препятствий «Сила молодёжи» — в формате спортивного шоу «Суперниндзя». В рамках полосы препятствий «Сила молодёжи» запланировано прохождение трассы для нескольких категорий индивидуальные / командные (3 чел.) — Дети, Семья, Студенты и Организации / Предприятия. Участники проходят предварительную регистрацию, которая будет анонсирована в социальных сетях.
        {'\n\n'}
  ...
  },
  {
    ...
    desc: 'Успей попробовать настоящую армейскую еду. Полевая кухня работает бесплатно.',
    img: programImg('patriot', 'rkka'),
    partners: null,
    tags: ['История', 'Еда', 'ВОВ'],
  },
  {
    id: 4,
